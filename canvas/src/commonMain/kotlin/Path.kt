...
/**
 * Marker interface for [Canvas] to associate it's own path type.
 *
 * A path describes a series of line segments and curves which can be used for complex drawing.
 */
public interface Path {

    /** Builder for a [Path] of type [P]. */
    public interface Builder<out P : Path> {
