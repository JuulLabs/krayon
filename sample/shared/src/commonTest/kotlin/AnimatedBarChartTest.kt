...
class AnimatedBarChartTest {
    ...
    fun barsAnimateFromBaselineToTargets() {
        ...
        val innerHeight = height - 24f // The chart applies a margin of 12 on each side.
        bars.forEach { bar -> assertTrue(bar.top == innerHeight, "bar should start at baseline") }
        ...
        // Past the end of all staggered animations (last delay 90ms + 750ms duration).
